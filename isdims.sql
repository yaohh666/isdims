...
--
-- Host: 127.0.0.1    Database: isdims
-- ------------------------------------------------------
...
CREATE TABLE `sale` (
  ...
  `amount` int NOT NULL,
  PRIMARY KEY (`goodsid`,`customerid`),
...
CREATE TABLE `supply` (
  ...
  PRIMARY KEY (`goodsid`,`supplierid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `supplyreturn`
--

DROP TABLE IF EXISTS `supplyreturn`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `supplyreturn`
--

LOCK TABLES `supplyreturn` WRITE;
/*!40000 ALTER TABLE `supplyreturn` DISABLE KEYS */;
/*!40000 ALTER TABLE `supplyreturn` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-31 15:23:30
